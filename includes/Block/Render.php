...
<?php echo wp_json_encode($recentPostsFa, JSON_HEX_TAG); ?>
  ...
  public function jsonInPre(array $title, string $id): self {
  ?>
    <pre style="display: none !important" id="<?php echo esc_attr($id); ?>">
<?php echo wp_json_encode($title, JSON_HEX_TAG); ?>
</pre>
<?php
    return $this;
  }
