  ...
  resources: {
    en: {
      translation: {
        ...
        Books: "Books",
        BooksPageQuote: 'Books Page Quote',
        Cancel: "Cancel",
        checkYourEmail: 'Please check your email to confirm your email address',
        chooseSliderImages: "Slider Images",
        closeQuote: "”",
        courseArchive: "Course Archive",
        ...
        CoursesPageQuote: 'Courses Page Quote',
        ...
        None: "None",
        notConfirmed: "Your email has not been confirmed",
        ...
        PapersPageQuote: 'Papers Page Quote',
        Papers: "Papers",
        ...
        videoDrop: "Click to add video or Drop your video  here",
        watch: "Watch",
    ...
    fa: {
      translation: {
        ...
        blogPosts: "نوشته‌ها",
        Books: "کتابنامه",
        BooksPageQuote: 'نقل‌قول صفحه کتاب‌ها',
        bookQuoteMain:
        ...
        chooseSliderImages: "تصاویر اسلایدر",
        closeQuote: "”",
        courseType: "نوع دوره",
        CoAuthors: "همکاران",
        CoAuthor: "همکار",
        CoTeacher: 'تدریسیار',
        comma: "،",
        commentAuthor: "نویسنده نظر",
        authorEmail: "ایمیل نویسنده",
        commentContent: "متن کامنت",
        Contact: "تماس با من",
        Content: "محتوا",
        ContentOfEmail: "متن نامه",
        Course: "دوره آموزشی",
        courseArchive: "آرشیو کلاس‌ها",
        Courses: "دوره‌ها",
        CourseDuration: 'طول دوره',
        CourseIntroduction: 'معرفی دوره',
        CoursesPageQuote: 'نقل‌قول صفحه دوره ها',
        ...
        LinkToPage: "لینک به صفحه",
        loading: "صبر کنید",
        Logout: 'خروج',
        MainQuote: 'نقل قول اصلی',
        More: "بیشتر",
        moreBooks: "کتاب‌های بیشتر",
        morePapers: "مقالات بیشتر",
        ...
        Newsletter: "خبرنامه",
        None: "خالی",
        notConfirmed: "ایمیل شما تایید نشده است",
        ...
        Papers: "مقالات",
        PapersPageQuote: 'نقل‌قول صفحه مقالات',
        Price: "قیمت",
        Publisher: "ناشر",
        ...
        Title: "عنوان",
        toRead: "مطالعه",
        UnapprovedComments: "نظرات تاییدنشده",
        Unavailable: "ناموجود",
        videoDrop: "برای افزودن ویدئو کلیک کنید یا ویدئو خود را در این محل رها کنید.",
        watch: "ببینید",
