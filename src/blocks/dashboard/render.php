...
?>
<div id="thedah-dashboard" data-home-url="<?php echo esc_attr(esc_url(home_url('/'))) ?>" data-site-title="<?php echo esc_attr((get_bloginfo('name'))) ?>" data-media-rest-url="<?php echo esc_attr(get_rest_url(null, "/wp/v2/media")); ?>" data-rest-nonce="<?php echo esc_attr(wp_create_nonce('wp_rest')); ?>" data-assets-fonts-url="<?php echo esc_attr(($container->get('assets.fonts.url'))) ?>" data-assets-images-url="<?php echo esc_attr(($container->get('assets.images.url'))) ?>" data-about-rest-url-en="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_about')); ?>" data-about-rest-url-fa="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_aboutfa')); ?>" data-book-rest-url-en="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_book')); ?>" data-book-rest-url-fa="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_bookfa')); ?>" data-paper-rest-url-en="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_paper')); ?>" data-paper-rest-url-fa="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_paperfa')); ?>" data-singlepost-rest-url-en="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_singlepost')); ?>" data-singlepost-rest-url-fa="<?php echo esc_attr(get_rest_url(null, "/wp/v2/" . $container->get('prefix') . '_singlepostfa')); ?>" data-about-en-fetched="<?php echo esc_attr($aboutEnFetched) ?>" data-about-fa-fetched="<?php echo esc_attr($aboutFaFetched) ?>" data-books-en-fetched="<?php echo esc_attr($booksEnFetched) ?>" data-books-fa-fetched="<?php echo esc_attr($booksFaFetched) ?>" data-papers-en-fetched="<?php echo esc_attr($papersEnFetched) ?>" data-papers-fa-fetched="<?php echo esc_attr($papersFaFetched) ?>" data-singleposts-en-fetched="<?php echo esc_attr($singlePostsEnFetched) ?>" data-singleposts-fa-fetched="<?php echo esc_attr($singlePostsFaFetched) ?>" data-resource-name="book" data-color-scheme="<?php echo esc_attr($colorScheme); ?>">
</div>
